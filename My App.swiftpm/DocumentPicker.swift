...
//https://developer.apple.com/forums/thread/124625
...
class DocumentPickerCoordinator: NSObject, UIDocumentPickerDelegate {
    ...
    public func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentAt url: URL) {
        ...
        do {
             ...
             /// With the Playground is not possible to create a new folder and save as new file the compressed one.
             /// For this reason, on the playgrond, the documentPicker will not work.
                //https://developer.apple.com/forums/thread/124625
